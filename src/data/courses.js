export const courses = [
  {
    ...
    chapters: [
      { title: "Module 1: Introduction to Agentic Workflows", duration: "45 mins", videoId: "BrsNcNS_5AM" },
      { title: "Module 2: Prompt Templates and Structured Outputs", duration: "60 mins", videoId: "v7s-t8c1xCo" },
      { title: "Module 3: Memory Systems and Vector Databases", duration: "75 mins", videoId: "3G-E682Pz6o" },
      { title: "Module 4: Building Custom Tools and ReAct Frameworks", duration: "90 mins", videoId: "mEsDeU7m1i0" },
      { title: "Module 5: Deploying Agents with LangServe", duration: "60 mins", videoId: "y1v5yM0BsnM" }
    ]
  },
  {
    id: 2,
    ...
    chapters: [
      { title: "Module 1: Interface Setup and Media Ingestion", duration: "35 mins", videoId: "7L_8Lz_aF9U" },
      { title: "Module 2: Rough Cuts, Trimming, and Editing Tools", duration: "50 mins", videoId: "Zt9cpxKmg-k" },
      { title: "Module 3: Color Pages, LUTs, and Secondary Grading", duration: "80 mins", videoId: "vFhLhPecR18" },
      { title: "Module 4: Visual Effects inside the Fusion Tab", duration: "90 mins", videoId: "J7k2t3_N1_Q" },
      { title: "Module 5: Audio Mastering with Fairlight", duration: "45 mins", videoId: "yU_e8s0N6yQ" }
    ]
  },
  {
    id: 3,
    ...
    chapters: [
      { title: "Module 1: Creational, Structural, and Behavioral Design Patterns", duration: "90 mins", videoId: "m1Yc2zM9YmE" },
      { title: "Module 2: The Python Object Model and Metaprogramming", duration: "70 mins", videoId: "cKPL9cW4vB0" },
      { title: "Module 3: Concurrency vs Parallelism: Multiprocessing and Threading", duration: "85 mins", videoId: "98c-sWv8sQ8" },
      { title: "Module 4: Asynchronous I/O with asyncio", duration: "95 mins", videoId: "f1uLhU36U1M" },
      { title: "Module 5: Testing and Profiling Concurrent Programs", duration: "50 mins", videoId: "8bWw1t28dYo" }
    ]
  },
  {
    id: 4,
    ...
    chapters: [
      { title: "Module 1: Understanding Tailwind v4's CSS-First Architecture", duration: "40 mins", videoId: "T7aTHud_w6M" },
      { title: "Module 2: Vite Plugin Setup and Asset Bundling", duration: "50 mins", videoId: "tS_a91-4B9Q" },
      { title: "Module 3: Building Responsive Layouts with Container Queries", duration: "65 mins", videoId: "r2u5yC4C9cE" },
      { title: "Module 4: Directives, Custom Utilities, and Theme Customization", duration: "80 mins", videoId: "qQc-J4X9U7w" },
      { title: "Module 5: Production Optimization, Purging, and Performance Auditing", duration: "45 mins", videoId: "w1uYc28c8bQ" }
    ]
  },
  {
    id: 5,
    ...
    chapters: [
      { title: "Module 1: Storyboarding and Type Layout", duration: "30 mins", videoId: "j6fHCoI6mSM" },
      { title: "Module 2: Premiere Pro Timeline Setup & Rough Sync", duration: "40 mins", videoId: "h1eUe17c8cQ" },
      { title: "Module 3: Dynamic Link and Transferring Assets to AE", duration: "45 mins", videoId: "t1v8yC3C7cE" },
      { title: "Module 4: Keyframing Motion, Easing, and Graph Editor", duration: "80 mins", videoId: "k2c-J5X8U8w" },
      { title: "Module 5: Audio Integration, SFX, and Final Rendering", duration: "55 mins", videoId: "x1uYc29c9bQ" }
    ]
  },
  {
    id: 6,
    ...
    moduleType: "multi",
    chapters: [
      { title: "Module 1: Tensors, Operations, and GPU Acceleration", duration: "50 mins", videoId: "V_xro1bcAuA" },
      { title: "Module 2: Autograd: Mechanics of Backpropagation", duration: "60 mins", videoId: "d1eUe18c9cQ" },
      { title: "Module 3: Neural Network Modules (nn.Module) and Layers", duration: "75 mins", videoId: "u1v9yC4C8cE" },
      { title: "Module 4: Dataset, DataLoader, and Custom Pipelines", duration: "70 mins", videoId: "l2c-J6X9U9w" },
      { title: "Module 5: Training Loops, Logging, and Checkpointing", duration: "90 mins", videoId: "y1uYc30c0bQ" }
    ]
  },
  {
    id: 7,
    slug: "single-video-python-crash-course-2026",
    title: "Python 100-Minute Full Crash Course (Single Module)",
    description: "Master all core Python concepts in one comprehensive, continuous single-module masterclass.",
    category: "Coding Skills",
    language: "English",
    rating: 4.9,
    votes: 310,
    ...
    type: "free",
    sampleVideoId: "gfDE2a7MKjA",
    youtubeUrl: "https://www.youtube.com/watch?v=gfDE2a7MKjA",
    tools: ["Python", "VS Code"],
    moduleType: "single",
    overview: "This single-module crash course delivers a complete end-to-end Python foundation in one unbroken video lesson. Designed for rapid learning without navigating multiple playlist modules.",
    chapters: [
      { title: "Complete Python Masterclass in 100 Minutes", duration: "1h 40m", videoId: "gfDE2a7MKjA" }
    ]
  },
  {
    id: 8,
    slug: "react-js-full-course-2026",
    title: "React.js & Next.js 15 Full Modern Web Masterclass",
    description: "Learn modern React 19, JSX, hooks, state management, and server components step-by-step.",
    category: "Coding Skills",
    language: "English",
    rating: 4.9,
    votes: 450,
    ...
    creatorLogo: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?auto=format&fit=crop&q=80&w=120&h=120",
    type: "free",
    sampleVideoId: "bMknFfOI-qa",
    youtubeUrl: "https://www.youtube.com/watch?v=bMknFfOI-qa",
    tools: ["React", "JavaScript", "Next.js", "Tailwind CSS"],
    moduleType: "multi",
    overview: "Master modern React 19 and Next.js 15 from scratch. This complete curriculum walks through components, state hooks, context API, and server actions with real-world app projects.",
    chapters: [
      { title: "Module 1: React Fundamentals & JSX Syntax", duration: "45 mins", videoId: "bMknFfOI-qa" },
      { title: "Module 2: State, Props, and Event Handling", duration: "60 mins", videoId: "w7ejDZ8SWv8" },
      { title: "Module 3: Custom Hooks & API Data Fetching", duration: "75 mins", videoId: "35lXWvCuM8o" },
      { title: "Module 4: Next.js App Router & Server Components", duration: "90 mins", videoId: "843nec-3Sgw" },
      { title: "Module 5: Building & Deploying a Full-Stack React App", duration: "105 mins", videoId: "d5x00sI80E8" }
    ]
  },
  {
    id: 9,
    slug: "complete-dsa-data-structures-algorithms",
    title: "Complete DSA (Data Structures & Algorithms) Roadmap",
    description: "Master arrays, linked lists, trees, graphs, dynamic programming, and LeetCode interview prep.",
    category: "Coding Skills",
    language: "Hindi",
    rating: 4.9,
    votes: 890,
    ...
    creatorName: "Striver (take U forward)",
    creatorLogo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=120&h=120",
    type: "free",
    sampleVideoId: "0bHoB3etf1U",
    youtubeUrl: "https://www.youtube.com/watch?v=0bHoB3etf1U",
    tools: ["DSA", "C++", "Java", "Python", "LeetCode"],
    moduleType: "multi",
    overview: "Comprehensive Data Structures & Algorithms course designed for technical interview preparation at top tech companies. Covers algorithmic patterns, time complexity analysis, and problem solving.",
    chapters: [
      { title: "Module 1: Time Complexity & Basic Math for DSA", duration: "60 mins", videoId: "0bHoB3etf1U" },
      { title: "Module 2: Arrays, Hashing, and Two-Pointer Techniques", duration: "90 mins", videoId: "37E9ckMDdTk" },
      { title: "Module 3: Linked Lists, Stacks, and Queues", duration: "120 mins", videoId: "Nq7Ok-OY42w" },
      { title: "Module 4: Binary Trees, BSTs, and Heap Data Structures", duration: "150 mins", videoId: "_PaO3hriZdo" },
      { title: "Module 5: Dynamic Programming & Graph Algorithms", duration: "210 mins", videoId: "M3_pLsDdeuU" }
    ]
  },
  {
    id: 10,
    slug: "full-stack-java-spring-boot-course",
    title: "Java Programming & Spring Boot Microservices Course",
    description: "Master Java OOP concepts, collections, multithreading, and Spring Boot REST API development.",
    category: "Coding Skills",
    language: "English",
    rating: 4.8,
    votes: 520,
    ...
    creatorLogo: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=120&h=120",
    type: "free",
    sampleVideoId: "BGTx91t8q50",
    youtubeUrl: "https://www.youtube.com/watch?v=BGTx91t8q50",
    tools: ["Java", "Spring Boot", "Hibernate", "PostgreSQL"],
    moduleType: "multi",
    overview: "Complete Java programming course for beginners to advanced backend developers. Learn object-oriented principles, JVM memory, Spring Data JPA, and microservice architecture.",
    chapters: [
      { title: "Module 1: Java Syntax, Data Types & Control Flow", duration: "60 mins", videoId: "BGTx91t8q50" },
      { title: "Module 2: Object-Oriented Programming (OOP) in Java", duration: "90 mins", videoId: "eIrMbAQSU34" },
      { title: "Module 3: Java Collections Framework & Lambdas", duration: "100 mins", videoId: "9jJu375-ZgU" },
      { title: "Module 4: Building REST APIs with Spring Boot", duration: "120 mins", videoId: "35EQXmHKZYs" },
      { title: "Module 5: Spring Data JPA & PostgreSQL Integration", duration: "110 mins", videoId: "Ke7Tr4SR6A0" }
    ]
  }
];
